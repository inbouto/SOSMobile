 ...
 */
public class MapsActivitySos extends AppCompatActivity
        implements OnMapReadyCallback {

    private static final String TAG = MapsActivitySos.class.getSimpleName();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.sos_current_place_menu, menu);
        return true;
    }
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                gps = new GPSTracker(MapsActivitySos.this);
        ...
        try {
            ...
            myRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    gps = new GPSTracker(MapsActivitySos.this);
                    long cpt = snapshot.getChildrenCount();
                    String cptStr = Long.toString(cpt);
                    ...
                    for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                        ...
                        Double lat = Double.parseDouble(listmarker.get(0));
                        Double lng = Double.parseDouble(listmarker.get(1));
                        ...
                        Log.w("calcule distance ",Float.toString(loc1.distanceTo(loc2)));
                        if(distanceInMeters < 500.0)
                        mMap.addMarker(new MarkerOptions()
                                .title(listmarker.get(2))
                                .position(marker)
                                .snippet("Cliquer ici pour afficher le chemin.")
                        );
                    }

                    Toast.makeText(MapsActivitySos.this,(cptStr + " défibrillateurs près de vous."),Toast.LENGTH_LONG).show();
                }
